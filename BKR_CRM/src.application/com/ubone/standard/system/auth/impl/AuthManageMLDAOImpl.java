...
import com.ubone.standard.system.auth.dao.AuthManageMLDAO;

@Repository
public class AuthManageMLDAOImpl extends UbSqlSessionDaoSupport implements AuthManageMLDAO {
	
	private static final String checked = "CHECKED";
	private final String PREFIX = "AuthManageML.";
