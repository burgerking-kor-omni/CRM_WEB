...
<%
	...
	DataList _dl_CouponManageDAO_getCouponDetail = ViewUtil.getResult().getDataList("CouponManageDAO.getCouponDetail");
%>
...
<!-- layout-1 Start -->
<h1 class="ub-control title">쿠폰 마스터 상세</h1>
...
<td id="layout-1_1_2" colspan=2><label id="lbl_obj" name="lbl_obj" class="ub-control label">기본레이블</label><input type=hidden id="CD_COUPON" name="CD_COUPON"    value="${paramMap.CD_COUPON}"></td>
</tr>
<tr id="layout-1_2">
<th id="layout-1_2_3"><label class="ub-control label">다우 쿠폰 정보</label></th>
<td id="layout-1_2_4" colspan=2><span class="ub-control button inner icon"     onclick="fnPopupDau()">    <a href="#none" title="쿠폰 상품 선택"><span></span>쿠폰 상품 선택</a></span><input type=hidden id="NO_REQ" name="NO_REQ"    value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "NO_REQ") %>"></td>
</tr>
<tr id="layout-1_3">
<th id="layout-1_3_5"><label class="ub-control label">쿠폰 핀 현황</label></th>
<td id="layout-1_3_6" colspan=2><span class="ub-control button inner icon"     onclick="fnPopupPin()">    <a href="#none" title="보기"><span></span>보기</a></span></td>
</tr>
<tr id="layout-1_4">
<th id="layout-1_4_7"><label class="ub-control label"             for="NM_COUPON">쿠폰명</label></th>
<td id="layout-1_4_8" colspan=2><input type=text  class="ub-control input-text " id="NM_COUPON" name="NM_COUPON"       value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "NM_COUPON") %>"     metaessential="1"           style="text-align:left;width:600px;"></td>
</tr>
<tr id="layout-1_5">
<th id="layout-1_5_9" rowspan=3><label class="ub-control label">쿠폰 이미지</label></th>
<td id="layout-1_5_10"><label id="lbl_App" name="lbl_App" class="ub-control label">OMNI 이미지(APP용)</label><br/><label class="ub-control label">&nbsp;</label><div class="ub-control temp" style="border:2px solid gray;width:100%;height:80px;text-align:center;"><h3 style="padding-top:30px;padding-left:10px;padding-right:10px;">Attach File Control</h3></div><span class="ub-control attachFile">   	<div class="filefieldset" id='uploadedFiles_IMG_APP'></div>   	<div class="filefieldset" id='uploadProgress_IMG_APP' style="display:none;">   		<span class="legend">Uploading...</span>   	</div>	<span id='btnUpload_IMG_APP'></span> </span></td>
<td id="layout-1_5_11"></td>
</tr>
<tr id="layout-1_6">
<td id="layout-1_6_12"><label id="lbl_Web" name="lbl_Web" class="ub-control label">OMNI 이미지(WEB용)</label><br/><label class="ub-control label">&nbsp;</label><div class="ub-control temp" style="border:2px solid gray;width:100%;height:80px;text-align:center;"><h3 style="padding-top:30px;padding-left:10px;padding-right:10px;">Attach File Control</h3></div><span class="ub-control attachFile">   	<div class="filefieldset" id='uploadedFiles_IMG_WEB'></div>   	<div class="filefieldset" id='uploadProgress_IMG_WEB' style="display:none;">   		<span class="legend">Uploading...</span>   	</div>	<span id='btnUpload_IMG_WEB'></span> </span></td>
<td id="layout-1_6_13"></td>
</tr>
<tr id="layout-1_7">
<td id="layout-1_7_14"><label id="lbl_Reward" name="lbl_Reward" class="ub-control label">리워드 이미지</label><br/><label class="ub-control label">&nbsp;</label><div class="ub-control temp" style="border:2px solid gray;width:100%;height:80px;text-align:center;"><h3 style="padding-top:30px;padding-left:10px;padding-right:10px;">Attach File Control</h3></div><span class="ub-control attachFile">   	<div class="filefieldset" id='uploadedFiles_IMG_REWARD'></div>   	<div class="filefieldset" id='uploadProgress_IMG_REWARD' style="display:none;">   		<span class="legend">Uploading...</span>   	</div>	<span id='btnUpload_IMG_REWARD'></span> </span></td>
<td id="layout-1_7_15"></td>
</tr>
<tr id="layout-1_8">
<th id="layout-1_8_16"><label class="ub-control label">유의사항</label></th>
<td id="layout-1_8_17" colspan=2><textarea class="ub-control textarea " id="DS_COUPON" name="DS_COUPON"       style="width:600px;" rows="5"                  rows="5"><%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "DS_COUPON") %></textarea></td>
</tr>
</tbody>
</table>
...
<td id="layout-1_2_4" colspan=5><input class="ub-control radio" type=radio  id="CD_SALE_POLICY" name="CD_SALE_POLICY"    checked value="1"      metaessential="1"><label> 정액할인</label><input class="ub-control radio" type=radio  id="CD_SALE_POLICY" name="CD_SALE_POLICY"     value="2"      metaessential="1"><label> 정율할인</label><input type=text  class="ub-control input-text " id="VAL_SALE_POLICY" name="VAL_SALE_POLICY" maxLength="7" metalength="7"      metaformat="number" value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "VAL_SALE_POLICY") %>"                style="text-align:left;width:100px;"><label id="LBL_POLICY" name="LBL_POLICY" class="ub-control label"> 원</label></td>
</tr>
<tr id="layout-1_3">
<th id="layout-1_3_5"><label class="ub-control label"             for="VAL_LIMIT_PRICE">최소 주문 금액</label></th>
<td id="layout-1_3_6" colspan=5><input type=text  class="ub-control input-text " id="VAL_LIMIT_PRICE" name="VAL_LIMIT_PRICE" maxLength="7" metalength="7"      metaformat="number" value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "VAL_LIMIT_PRICE") %>"     metaessential="1"           style="text-align:left;width:100px;"><label class="ub-control label"> 원 이상 주문에만 적용 (0 이면 제한 없음)</label></td>
</tr>
<tr id="layout-1_4">
...
<td id="layout-1_4_9" colspan=3><input type=text  class="ub-control input-text " id="PRODUCT_PK" name="PRODUCT_PK"       value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "PRODUCT_PK") %>"  readonly   metaessential="1"           style="text-align:left;width:50px;"><input type=text  class="ub-control input-text " id="MENU_NM" name="MENU_NM"       value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "NM_PROD") %>"                style="text-align:left;width:100px;"><span class="ub-control button inner icon"     onclick="fnPopupMenu();">    <a href="#none" title="상품찾기"><span></span>상품찾기</a></span></td>
...
<td id="layout-1_5_12" colspan=3><input type=text  class="ub-control input-text " id="PRODUCT_PK_REAL" name="PRODUCT_PK_REAL"       value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "PRODUCT_PK_REAL") %>"  readonly   metaessential="1"           style="text-align:left;width:50px;"><input type=text  class="ub-control input-text " id="MENU_NM_REAL" name="MENU_NM_REAL"       value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "NM_PROD_REAL") %>"                style="text-align:left;width:100px;"><span class="ub-control button inner icon"     onclick="fnPopupMenuReal()">    <a href="#none" title="상품찾기"><span></span>상품찾기</a></span></td>
</tr>
<tr id="layout-1_6">
...
<td id="layout-1_6_15" colspan=4><input type=text  class="ub-control input-text " id="NM_CUP_MENU" name="NM_CUP_MENU"       value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "NM_CUP_MENU") %>"     metaessential="1"           style="text-align:left;width:245px;"></td>
</tr>
<tr id="layout-1_7">
...
<tr id="layout-1_8">
<td id="layout-1_8_21"><input type=text  class="ub-control input-text " id="REAL_CUP_PRICE" name="REAL_CUP_PRICE" maxLength="7" metalength="7"      metaformat="number" value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "REAL_CUP_PRICE") %>"     metaessential="1"           style="text-align:left;width:100px;"><label class="ub-control label"> 원</label></td>
<td id="layout-1_8_22"><input type=text  class="ub-control input-text " id="SALE_CUP_PRICE" name="SALE_CUP_PRICE" maxLength="7" metalength="7"      metaformat="number" value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "SALE_CUP_PRICE") %>"     metaessential="1"           style="text-align:left;width:100px;"><label class="ub-control label"> 원</label></td>
<td id="layout-1_8_23"><input type=text  class="ub-control input-text " id="SALE_CUP_RATE" name="SALE_CUP_RATE" maxLength="3" metalength="3"      metaformat="number" value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "SALE_CUP_RATE") %>"     metaessential="1"           style="text-align:left;width:20px;"><label class="ub-control label">%</label></td>
...
<td id="layout-1_9_26" colspan=5><input type=text class="ub-control input-text calendar " id="DT_EXPIRY_START" name="DT_EXPIRY_START"       metaformat="date" value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "DT_EXPIRY_START") %>"     metaessential="1"           style="text-align:left;width:75px;"><label class="ub-control label"> ~ </label><input type=text class="ub-control input-text calendar " id="DT_EXPIRY_END" name="DT_EXPIRY_END"       metaformat="date" value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "DT_EXPIRY_END") %>"     metaessential="1"           style="text-align:left;width:75px;"></td>
</tr>
<tr id="layout-1_10">
<th id="layout-1_10_27"><label class="ub-control label"             for="TP_EXPIRY_DATE">쿠폰 핀 유효기간</label></th>
<td id="layout-1_10_28" colspan=5><select id="TP_EXPIRY_DATE" name="TP_EXPIRY_DATE" class="ub-control select "     style="width:150px;" size="1"  defaultvalue="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "TP_EXPIRY_DATE") %>"     metaessential="1"></select><label class="ub-control label"     style="color:#db482b;;">※ 지정유효기간일때 쿠폰의 유효기간과 동일하게 설정된다.</label></td>
</tr>
<tr id="layout-1_11">
...
<td id="layout-1_1_4"><h4 class="ub-control title">제외 매장</h4><br/><select id="TP_STOR_EX" name="TP_STOR_EX" class="ub-control select "     style="width:200px;" size="1"></select></td>
</tr>
<tr id="layout-1_2">
<td id="layout-1_2_5"><input type=text  class="ub-control input-text " id="NM_STORE_SEARCH" name="NM_STORE_SEARCH"                       style="text-align:left;width:140px;"><span class="ub-control button inner icon"     onclick="searchStore();">    <a href="#none" title="검색"><span></span>검색</a></span></td>
...
<input type=hidden id="CD_GOODS" name="CD_GOODS"    value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "CD_GOODS") %>">
<input type=hidden id="NM_GOODS" name="NM_GOODS"    value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "NM_GOODS") %>">
<input type=hidden id="IMG_GOODS" name="IMG_GOODS"    value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "IMG_GOODS") %>">
<input type=hidden id="CNT_PIN" name="CNT_PIN"    value="<%=JspUtils.getDefaultValue(_dl_CouponManageDAO_getCouponDetail, "CNT_PIN") %>">
</form>
...
<span class="ub-control button bottom icon"     onclick="fnDelete();">
    <a href="#none" title="Save"><span class="ico-save"></span>삭제</a>
</span>
<span class="ub-control button bottom icon"     onclick="fnReReg();">
