...
<!-- layout-1 Start -->
<h1 class="ub-control title">연령대별 회원 현황 </h1>
...
<tr id="layout-1_2">
<th id="layout-1_2_5"><label class="ub-control label">멤버십</label></th>
<td id="layout-1_2_6"><select id="CD_GRADE" name="CD_GRADE" class="ub-control select "     style="width:120px;" size="1"></select></td>
