...
<!-- layout-1 Start -->
<h1 class="ub-control title">기간별 회원 현황 (년도별)</h1>
...
<td id="layout-1_1_2"><select id="DT_START_Y" name="DT_START_Y" class="ub-control select "     style="width:90px;" size="1"></select></td>
<th id="layout-1_1_3"><label class="ub-control label">성별</label></th>
<td id="layout-1_1_4"><select id="CD_GENDER" name="CD_GENDER" class="ub-control select "     style="width:120px;" size="1"></select></td>
</tr>
<tr id="layout-1_2">
...
<div class="ub-layout " id="listLayout" name="listLayout"></div>
