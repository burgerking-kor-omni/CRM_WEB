...
<td id="layout-1_1_2" colspan=2><input type=text  class="ub-control input-text " id="TP_SET" name="TP_SET"       value="<%=JspUtils.getDefaultValue(_dl_stampManageDAO_getTbsStamp, "TP_SET") %>"  readonly              style="text-align:left;width:100px;"   disabled><input type=hidden id="NO_STAMP" name="NO_STAMP"    value="${paramMap.NO_STAMP}"></td>
<th id="layout-1_1_3"><label class="ub-control label"             for="DT_APPLY_START,DT_APPLY_END">적용기간</label></th>
<td id="layout-1_1_4" colspan=3><input type=text class="ub-control input-text calendar " id="DT_APPLY_START" name="DT_APPLY_START"       metaformat="date" value="<%=JspUtils.getDefaultValue(_dl_stampManageDAO_getTbsStamp, "DT_APPLY_START") %>"     metaessential="1"           style="text-align:left;width:75px;"><label class="ub-control label"      style="width:100px;"    metaformat="date"> ~ </label><input type=text class="ub-control input-text calendar " id="DT_APPLY_END" name="DT_APPLY_END"       metaformat="date" value="<%=JspUtils.getDefaultValue(_dl_stampManageDAO_getTbsStamp, "DT_APPLY_END") %>"     metaessential="1"           style="text-align:left;width:75px;"></td>
</tr>
<tr id="layout-1_2">
<th id="layout-1_2_5"><label class="ub-control label"             for="DS_TITLE">제목</label></th>
<td id="layout-1_2_6" colspan=2><input type=text  class="ub-control input-text " id="DS_TITLE" name="DS_TITLE" maxLength="50" metalength="50"       value="<%=JspUtils.getDefaultValue(_dl_stampManageDAO_getTbsStamp, "DS_TITLE") %>"     metaessential="1"           style="text-align:left;width:250px;"></td>
<th id="layout-1_2_7"><label class="ub-control label"             for="FG_USE_MAIN">사용여부</label></th>
<td id="layout-1_2_8" colspan=3><select id="FG_USE_MAIN" name="FG_USE_MAIN" class="ub-control select "     style="width:120px;" size="1"  defaultvalue="<%=JspUtils.getDefaultValue(_dl_stampManageDAO_getTbsStamp, "FG_USE") %>"     metaessential="1"></select></td>
</tr>
<tr id="layout-1_3">
...
<div class="ub-layout "><h2 class="ub-control title" id="lbl_stnd" name="lbl_stnd" for="standardInfo2" hfold="1">적립기준</h2>
...
<td id="layout-1_1_4"><br/><h4 class="ub-control title">제외 매장</h4><br/><select id="TP_STOR_EX" name="TP_STOR_EX" class="ub-control select "     style="width:200px;" size="1"></select></td>
</tr>
<tr id="layout-1_2">
...
<span class="ub-control button bottom icon" id="delBtn"     onclick="fnDel()">
    <a href="#none" title="삭제"><span></span>삭제</a>
</span>
</div>
</form>
