...
<!-- layout-1 Start -->
<h1 class="ub-control title">자유게시판 목록</h1>
...
<td id="layout-1_1_2"><input type=text  class="ub-control input-text " id="DS_TITLE" name="DS_TITLE"       value="${paramMap.DS_TITLE}"                style="text-align:left;width:280px;"></td>
<th id="layout-1_1_3"></th>
<td id="layout-1_1_4"></td>
</tr>
<tr id="layout-1_2">
<th id="layout-1_2_5"><label class="ub-control label">등록일자</label></th>
<td id="layout-1_2_6"><input type=text class="ub-control input-text calendar " id="DT_REG_START" name="DT_REG_START"                        style="text-align:left;width:100px;"><label class="ub-control label">~</label><input type=text class="ub-control input-text calendar " id="DT_REG_END" name="DT_REG_END"                        style="text-align:left;width:100px;"></td>
