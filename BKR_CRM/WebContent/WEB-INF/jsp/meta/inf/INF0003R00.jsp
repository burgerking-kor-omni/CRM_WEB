...
<td id="layout-1_1_2" colspan=3><input type=text  class="ub-control input-text " id="DS_TITLE" name="DS_TITLE"            metaessential="1"           style="text-align:left;width:650px;"></td>
</tr>
<tr id="layout-1_2">
<th id="layout-1_2_3"><label class="ub-control label"             for="DS_NOTICE">내용</label></th>
<td id="layout-1_2_4" colspan=3><textarea class="ub-control textarea " id="DS_NOTICE" name="DS_NOTICE"       style="width:650px;" rows="20"      metaessential="1"            rows="20"></textarea></td>
</tr>
<tr id="layout-1_3">
<th id="layout-1_3_5"><label class="ub-control label">게시여부</label></th>
<td id="layout-1_3_6"><input class="ub-control input-checkbox" type="checkbox" id="FG_OPEN_PORTAL" name="FG_OPEN_PORTAL"     value="Y"><label>게시여부</label></input></td>
<th id="layout-1_3_7"><label class="ub-control label">공지기간</label></th>
<td id="layout-1_3_8"><input type=text class="ub-control input-text calendar " id="DT_START" name="DT_START"       metaformat="date"                 style="text-align:left;width:100px;"><label class="ub-control label">~</label><input type=text class="ub-control input-text calendar " id="DT_END" name="DT_END"       metaformat="date"                 style="text-align:left;width:100px;"></td>
</tr>
<tr id="layout-1_4">
