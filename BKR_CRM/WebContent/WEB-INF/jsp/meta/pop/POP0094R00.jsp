...
<!-- layout-1 Start -->
<h1 class="ub-control title">일괄 핀 발행</h1>
...
<div class="ub-layout button inner"  style="text-align:right;"><span class="ub-control button inner icon"     onclick="fnAdd()">
    <a href="#none" title="추가"><span></span>추가</a>
</span>
<span class="ub-control button inner icon"     onclick="fnDel()">
...
<div class="ub-layout button bottom"><span class="ub-control button bottom icon"     onclick="fnPublish()">
    <a href="#none" title="일괄 핀 발행"><span></span>일괄 핀 발행</a>
</span>
