...
<!-- layout-1 Start -->
<div class="ub-layout list"><form id="listForm" name="listForm"><input type=hidden id="ID_CUST" name="ID_CUST">
<div class="ub-layout button inner"  style="text-align:right;"><select class="ub-control select "     style="width:120px;" size="1"></select>
</div>
</form>
