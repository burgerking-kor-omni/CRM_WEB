...
<!-- layout-1 Start -->
<h1 class="ub-control title">사용자 접속 로그</h1>
...
<td id="layout-1_1_2"><input type=text  class="ub-control input-text " id="USER_NM" name="USER_NM"                       style="text-align:left;width:106px;"></td>
<th id="layout-1_1_3"><label class="ub-control label">부서</label></th>
<td id="layout-1_1_4"><input type=text  class="ub-control input-text " id="DEPT_NM" name="DEPT_NM"                       style="text-align:left;width:106px;"></td>
</tr>
</tbody>
</table>
