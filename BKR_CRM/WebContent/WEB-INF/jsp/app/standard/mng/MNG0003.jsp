...
uxl.onLoad(function(){
	...
	var options1 = {
		...
		,colModel:[
		          ...
		          ,{name:'FG_USE' , width:5 ,align:'center',sortable:false}
...
function fnSetScreen(){
	...
	// 킹오더 코드 삭제
// 	$('#MENU_CATEGORY_1 option[value*="K"]').remove();
	...
	//자동완성 기능(내용유형)
	uxl.autocomplete('MENU_NAME', uxl.getFunctionUrl(_SCREEN_ID,'USERDEFINED1'),  {
		  minLength : 2
