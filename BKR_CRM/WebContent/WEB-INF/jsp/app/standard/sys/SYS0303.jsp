...
<tr id="layout-1_1">
	...
	<td id="layout-1_1_2">
		<input type=text  class="ub-control input-text " id="ID_BOARD" name="ID_BOARD" value=""  metaessential="1" style="text-align:left;width:100px;">
...
<tr id="layout-1_5">
	<th id="layout-1_5_9"><label class="ub-control label"             for="">게시판 테마</label></th>
	<td id="layout-1_5_10"></td>
</tr>
</tbody>
</table>
...
function fnSearch() {
	...
	var option = {
	  ...
	  , success:function(result) {
			...
			if (rowCount > 0) {
				$("#lblMessage").html('<b><font color=\'red\'>이미 존재하는 게시판 ID 입니다.</font></b>');
				registFlag = false;
			} else {
				$("#lblMessage").html('<b><font color=\'green\'>사용가능한 게시판 ID 입니다.</font></b>');
				registFlag = true;
			}
			$("#lblMessage").show();
	    }
...
function fnRegist() {	
	...
	var option = {
	  ...
	  , success:function(result) {
		  	uxl.moveLocation(uxl.getScreenURL('SYS0304') + '?ID_BOARD=' + boardId);
		}
	  , async:true
	  , message : {
