...
uxl.onLoad(function(){
	...
	uxl.bindComboCode('DT_END_Y', 'CD_YEAR', {emptyOption:'전체'});
	uxl.bindComboCode('DT_END_M', 'CD_MONTH', {emptyOption:'전체'});
...
uxl.onLoadComplete(function(){
	...
	// 기간을 저번달로 기준으로
	var test = new Date('${paramMap.DT_MONTH}');
	test = test.getMonth()+1;
	$('#DT_START_M').val(test < 10 ? '0'+test : test).change();
