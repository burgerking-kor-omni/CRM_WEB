...
uxl.onLoad(function(){
	...
	var options = {
		...
		//mapping column
		,colModel:[
				  {name:'AA'	,width:130 ,align:'center',sortable:false}
...
uxl.onLoadComplete(function(){
	...
	var dtStartM = new Date('${paramMap.DT_START_D}');

	var mm = (dtStartM.getMonth()+1)<10?'0'+(dtStartM.getMonth()+1):(dtStartM.getMonth()+1)+'';
	$('#DT_START_M').val(mm);
	
	var dd = dtStartM.getDate()<10?'0'+dtStartM.getDate():dtStartM.getDate()+'';
	$('#DT_START_D').val(dd);
