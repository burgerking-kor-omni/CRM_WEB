...
uxl.onLoad(function(){
	...
	var options = {
		//header name
		colNames:['MENU_CD','상품명','매장내가격','딜리버리가격','상태']
		
		//mapping column
		,colModel:[
		           {name:'MENU_CD' ,hidden:true}
		          ,{name:'MENU_NM' ,width:30}
		          ,{name:'DINE_IN_PRC' ,width:10}
		          ,{name:'DELIVERY_PRC' ,width:10}
		          ,{name:'USE_YN' ,width:10}
		         ]
		,autowidth:true
		,height:300
		,multiselect:true
