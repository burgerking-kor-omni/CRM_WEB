...
<h1 class="ub-control title">Total Pivot</h1>
...
<h2 class="ub-control title">Total Pivot</h2>

<div class="ub-layout list"><div class="ub-control temp" style="border:2px solid gray;width:100%;height:300px;text-align:center;"><h3 style="padding-top:120px;">Grid Control</h3></div>
<table class="ub-control grid" id="totalList" name="totalList"></table> 
</div>
...
function fnSetPivotGrid(dataSet){
	...
	uxl.grid.pivot('totalList', gridOptions, pivotOptions, dataSet);
}
