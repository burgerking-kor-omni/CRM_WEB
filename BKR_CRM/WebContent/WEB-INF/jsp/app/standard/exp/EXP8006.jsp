...
<h1 class="ub-control title">Hierarchy Pivot</h1>
...
<h2 class="ub-control title">Hierarchy Pivot</h2>

<div class="ub-layout list"><div class="ub-control temp" style="border:2px solid gray;width:100%;height:300px;text-align:center;"><h3 style="padding-top:120px;">Grid Control</h3></div>
<table class="ub-control grid" id="hierarchyList" name="hierarchyList"></table> 
</div>
...
uxl.onLoad(function(){	
	...
	var options = {
		//header name
		colNames:['카테고리명', '제품명', '국가', '가격'] //'제품명', '국가', , '수량'
...
// 	    , colTotals : true
	...
	uxl.grid.pivot('hierarchyList', gridOptions, pivotOptions, dataSet);
}
