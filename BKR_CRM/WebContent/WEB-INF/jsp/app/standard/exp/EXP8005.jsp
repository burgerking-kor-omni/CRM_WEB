...
<h1 class="ub-control title">Basic Pivot</h1>
...
<h2 class="ub-control title">Basic Pivot</h2>

<div class="ub-layout list"><div class="ub-control temp" style="border:2px solid gray;width:100%;height:300px;text-align:center;"><h3 style="padding-top:120px;">Grid Control</h3></div>
<table class="ub-control grid" id="basicList" name="basicList"></table> 
</div>
...
uxl.onLoad(function(){	
	...
	var options = {
		//header name
		colNames:['카테고리명', '가격'] //'제품명', '국가', , '수량'
		
		//mapping column
		, colModel:[
			    {name:'CATEGORYNAME',  	width:10, align:'left'}
// 			  , {name:'PRODUCTNAME',    width:15, align:'left'}
// 			  , {name:'COUNTRY',    	width:55, align:'center'}
...
function fnSetPivotGrid(dataSet){
	var pivotOptions = {
          xDimension: [{ dataName: 'CATEGORYNAME', label: '카테고리명' , width:15}]
        , yDimension: []
        , aggregates: [{
        	  formatter: setComma,
              member: 'PRICE',
	...
	uxl.grid.pivot('basicList', gridOptions, pivotOptions, dataSet);
}
