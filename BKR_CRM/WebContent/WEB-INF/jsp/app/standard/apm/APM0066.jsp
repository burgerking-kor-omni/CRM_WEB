...
uxl.onLoad(function() {
	...
	var options = {
			...
			//mapping column
			, colModel:[
				       {name:'SCREEN_TYPE',width:40, align:'center'}
	...
	// 조회권한 선택
	var combo = "<select id='retrive_all'></select>"; 
	...
	$('#BTN_SCREEN_ADD').bind("click", function() {
		uxl.openWindow('Search_Screen', uxl.getScreenURL('APM0067'), { width:'400px' ,height:'550px' }, callbackScreenAdd);		
	});
