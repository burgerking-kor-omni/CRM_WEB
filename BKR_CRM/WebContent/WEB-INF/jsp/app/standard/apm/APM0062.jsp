...
<!--  ========================================================================
 ...
 ========================================================================
--> 
<c:set var="detail" value="${CodeML_selectCodeCategoryDetail[0]}" />
...
<td id="layout-1_1_2"><input type=text  class="ub-control input-text " id="CODE_CATEGORY_ID" name="CODE_CATEGORY_ID"       value="${detail.CODE_CATEGORY_ID}"  readonly   metaessential="1"           style="text-align:left;width:150px;"></td>
<th id="layout-1_1_3"><label class="ub-control label"             for="CODE_CATEGORY_NM">코드유형명</label></th>
<td id="layout-1_1_4"><input type=text  class="ub-control input-text " id="CODE_CATEGORY_NM" name="CODE_CATEGORY_NM"       value="${detail.CODE_CATEGORY_NM}"     metaessential="1"           style="text-align:left;width:150px;"></td>
<td id="layout-1_1_5"></td>
<td id="layout-1_1_6"></td>
</tr>
<tr id="layout-1_2">
<th id="layout-1_2_7"><label class="ub-control label"             for="CODE_TP">코드유형</label></th>
<td id="layout-1_2_8"><ub:code-select id="CODE_TP" codeCategory="CODE_TP" style="width:120px;" essential="true" defaultValue="${detail.CODE_TP}"/></td>
<th id="layout-1_2_9"><label class="ub-control label">상위코드</label></th>
<td id="layout-1_2_10"><input type=text  class="ub-control input-text " id="CODE_CATEGORY_ID_UP" name="CODE_CATEGORY_ID_UP"       value="${detail.CODE_CATEGORY_ID_UP}"  readonly              style="text-align:left;width:150px;"></td>
...
<td id="layout-1_3_14"><ub:code-select id="CONSTANT_REG_YN" codeCategory="FLAG_YN" style="width:120px;" essential="true" defaultValue="${detail.CONSTANT_REG_YN}"/></td>
<th id="layout-1_3_15"><label class="ub-control label"             for="CACHE_YN">캐쉬여부</label></th>
<td id="layout-1_3_16"><ub:code-select id="CACHE_YN" codeCategory="FLAG_YN" style="width:120px;" essential="true" defaultValue="${detail.CACHE_YN}"/></td>
<td id="layout-1_3_17"></td>
<td id="layout-1_3_18"></td>
</tr>
<tr id="layout-1_4">
<th id="layout-1_4_19"><label class="ub-control label"             for="STATUS">상태</label></th>
<td id="layout-1_4_20"><ub:code-select id="STATUS" codeCategory="STATUS" style="width:120px;" essential="true" defaultValue="${detail.STATUS}"/></td>
<th id="layout-1_4_21"><label class="ub-control label">코드맵핑사용여부</label></th>
<td id="layout-1_4_22">
	<input class="ub-control radio" type=radio  id="MAPPING_YN" name="MAPPING_YN"  ${detail.MAPPING_YN == "Y"?"checked":""} value="Y"><label>사용</label>
	<input class="ub-control radio" type=radio  id="MAPPING_YN" name="MAPPING_YN"  ${detail.MAPPING_YN == "N"?"checked":""} value="N"><label>미사용</label>
</td>
...
<td id="layout-1_5_26" colspan=5><input type=text  class="ub-control input-text " id="ENUM_CLASS_NAME" name="ENUM_CLASS_NAME"       value="${detail.ENUM_CLASS_NAME}"                style="text-align:left;width:500px;"></td>
</tr>
<tr id="layout-1_6">
<th id="layout-1_6_27"><label class="ub-control label">코드정의쿼리</label></th>
<td id="layout-1_6_28" colspan=5><textarea class="ub-control textarea " id="CODE_QUERY_CONTENT" name="CODE_QUERY_CONTENT"       style="width:600px;" rows="5"                  rows="5">${detail.CODE_QUERY_CONTENT}</textarea><div class="ub-layout button inner"><span class="ub-control button inner icon" id="viewCodeBtn">    <a href="#none" title="코드보기"><span></span>코드보기</a></span></div></td>
</tr>
<tr id="layout-1_7">
<th id="layout-1_7_29"><label class="ub-control label"             for="TABLE_ID">원천코드테이블ID</label></th>
<td id="layout-1_7_30"><input type=text  class="ub-control input-text " id="TABLE_ID" name="TABLE_ID"       value="${detail.TABLE_ID}"                style="text-align:left;width:100px;"></td>
<th id="layout-1_7_31"><label class="ub-control label"             for="CODE_COLUMN_ID">원천코드컬럼ID</label></th>
<td id="layout-1_7_32"><input type=text  class="ub-control input-text " id="CODE_COLUMN_ID" name="CODE_COLUMN_ID"       value="${detail.CODE_COLUMN_ID}"                style="text-align:left;width:100px;"></td>
<th id="layout-1_7_33"><label class="ub-control label"             for="NAME_COLUMN_ID">원천명칭컬럼ID</label></th>
<td id="layout-1_7_34"><input type=text  class="ub-control input-text " id="NAME_COLUMN_ID" name="NAME_COLUMN_ID"       value="${detail.NAME_COLUMN_ID}"                style="text-align:left;width:100px;"></td>
</tr>
</tbody>
</table>
...
uxl.onLoad(function(){
	...
	$('#listBtn').click(function(){
		uxl.returnToList('APM0060');
	});

	// 코드 등록 팝업창
	$('#insertBtn').click(function(){
		var listner = function(){};
		var url = uxl.getScreenURL('APM0063') + '?CODE_CATEGORY_ID=' + $('#CODE_CATEGORY_ID').val();
	...
	$('#viewCodeBtn').click(function(){
		var listner = function(){};
		var url = uxl.getScreenURL('APM0065') + '?CODE_CATEGORY_ID=' + $("#CODE_CATEGORY_ID").val();
	...
	var options2 = {
			...
			,onCellSelect: function(rowid, iCol){
				if(iCol == 0){
					...
					var listner = function(){};
					var url = uxl.getScreenURL('APM0064') + '?CODE_CATEGORY_ID=' + selectedRow.CODE_CATEGORY_ID +'&CODE='+selectedRow.CODE;
					uxl.openWindow('Popup', url, { width:800 ,height:355 }, listner);
				}
			}
		};
