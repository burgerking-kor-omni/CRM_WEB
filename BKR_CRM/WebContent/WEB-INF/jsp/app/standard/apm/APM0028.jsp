...
uxl.onLoad(function(){
	...
	$('#btnList').click(function() {
		uxl.returnToList(uxl.getScreenURL('APM0027'));
	});
	...
	var svcOptions = {
		  ...
		  , colModel:[
			  ...
			  , {name:'SERVICE_TYPE',     width:10, align:'center' , codeCategory:'APMD_SERVICE_TYPE'}
			  , {name:'CALL_TYPE',    width:15, align:'center'	, codeCategory:'APMD_CALL_TYPE'}
			]
		  , autowidth:true
		  , height:261
		  , multiselect:false
		  , onSelectRow: function(rowid){
				...
				uxl.openWindow('servicePop', uxl.getScreenURL('APM0006') + param, {width:1000, height:660});
			}
	};			
...
function deleteMask() {
	...
	var option = {
		data:{"ID_MASK" : maskId}
	  , success:function(result) {
		  uxl.moveLocation(uxl.getScreenURL('APM0027'));
		}
	  , async:true
	  , message : {
