...
<form id="defaultForm" name="defaultForm">
	...
	<jsp:include page="../base/include/answerUpdateBody.jsp" flush="true"/>
...
<jsp:include page="../base/include/answerUpdateBottomButton.jsp" flush="true"/>
