...
<form id="defaultForm" name="defaultForm">
	...
	<!-- 리스트헤더 -->
	<jsp:include page="../base/include/listHeader.jsp" flush="true"/>

	<!-- 리스트 -->
	<jsp:include page="../base/include/listDefault.jsp" flush="true"/>

	<!-- 리스트검색 -->
	<jsp:include page="../base/include/listSearch.jsp" flush="true"/>
</form>
