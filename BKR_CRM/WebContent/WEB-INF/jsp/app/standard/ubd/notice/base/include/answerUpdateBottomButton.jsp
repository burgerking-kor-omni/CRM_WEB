<%--
#*
 *  파 일 명 :  answerUpdateBottomButton.jsp
 *  설    명 :  답변수정화면 하단 버튼영역
 *  작 성 자 :  
 *  작 성 일 :  
 *  버    전 :  1.0
...
<div class="ub-layout button bottom">
	<span class="ub-control button bottom icon" title="수정" id="btnUpdateAnswer">
