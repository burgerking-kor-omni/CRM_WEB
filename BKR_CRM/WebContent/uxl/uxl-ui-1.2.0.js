...
//		});
	...
	*/
	...
	uxl.setLinkAPMD = function(){
		...
		if(_SERVER_MODE == 'local' && passFlag){
			var html = '<section class="ub-frame toolbar"><div class="ub-layout apmd-panel">';
			html += '<a class="apmd-link" href="#none" title="Link APMD">APMD</a>&nbsp;';
			html += '<a class="message-debug" href="#none" title="Message Debug">Msg.Debug</a></div></section>';
