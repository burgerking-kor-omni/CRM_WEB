(function($, uxl) {
	 ...
	 *  
	 *  - 1.3.0 : 2016-07-13
	 *          - Add 함수 호출시 기존 Tab이 존재할 경우 요청되는 URL로 페이지를 로딩하는 기능으로 변경
	 * 
...
//		'<li><a href="#{href}"><label>#{label}</label></a><span class="ui-icon ui-icon-close" style="cursor:pointer;">Remove Tab</span></li>'		
	...
	uxl.Tabs.prototype.getIFrame = function(index) {
		return this.getIFrameByIndex(this.getTabIndex(id));
	};
	
	uxl.Tabs.prototype.getIFrameByIndex = function(index) {
