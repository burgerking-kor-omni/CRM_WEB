...
;(function($, uxl) {
	...
	$(document).ready(function() {
		...
		$(":input[readonly=readonly]").bind("click",function(event){
			$(this).blur();
		});
	...
	uxl.disableShortcuts = function(flag){
		var maskKey = 'F1, F3, F5, Backspace, Alt+Left, Alt+Right';
	...
	*/
	...
	uxl.setLinkAPMD = function(){
		...
		if(_SERVER_MODE == 'local' && passFlag){
			$('body').append('<section class="ub-frame toolbar"><div class="ub-layout apmd-panel"><a class="apmd-link" href="#none" title="Link APMD">APMD Info.</a></div></section>');
