...
*/
	...
	uxl.showLodingDiv = function(){
		var $loading = $('<div id="divLoading" class="loading-wrap"><div class="loading loading01"></div></div>');
		$('body').append($loading);
		
		var width = $loading.width();
		if(500 < width && width <= 1000){
			$('.loading', $loading).removeClass('loading01').addClass('loading02');
		}else if(width <= 500){
			$('.loading', $loading).removeClass('loading01').addClass('loading03');
		}
	};
