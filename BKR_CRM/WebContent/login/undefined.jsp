...
<div class="ub-page error">
	...
	<div class="ub-layout errorCon" style="width:70%;margin:0 auto;">
		<div class="errorCon-float">
			<!--<strong>에러 메세지 : </strong>&nbsp;<span>현재 로그인 계정의 상태가 정의되지 않은 코드<%=loginStatusCd %>로 로그인에 실패하였습니다. 관리자에게 문의하시기 바랍니다.</span>-->
			<strong>에러 메세지 : </strong>&nbsp;<span>사용자 신청이 필요한 로그인 계정입니다. 관리자에게 문의하시기 바랍니다.</span>
		</div>
	</div>
